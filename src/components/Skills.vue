    ...
    <div class="holder">
      <form @submit.prevent="addSkill">
        <input
          ...
          v-validate="'min:3'"
          type="text"
          class="focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal"
        ...
        <transition name="alert-in">
          <div
            ...
            class="alert bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
            role="alert"
          >
